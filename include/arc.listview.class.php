...
class ListView
{
    ...
    function GetPageListST($list_len, $listitem = "index,end,pre,next,pageno")
    {
        ...
        if ($totalpage <= 1 && $this->TotalResult > 0) {
            return "<span class='cust_txt'>记录总数：$this->TotalResult | 页数：1</span>";
//            return "<li><span class=\"pageinfo\">共 <strong>1</strong>页<strong>" . $this->TotalResult . "</strong>条记录</span></li>\r\n";
        }
        if ($this->TotalResult == 0) {
            return "<span class='cust_txt'>记录总数：0 | 页数：0</span>";
...
//            $indexpage = "<li><a href='" . str_replace("{page}", 1, $tnamerule) . "'>首页</a></li>\r\n";
            $prepage = "<a class='oran_pg_pp' href='" . str_replace("{page}", $prepagenum, $tnamerule) . "'>&nbsp;</a>";
            $indexpage = "<a class='oran_pg_fp' href='" . str_replace("{page}", 1, $tnamerule) . "'>&nbsp;</a>";
        } else {
//            $indexpage = "<li>首页</li>\r\n";
        }
...
//            $endpage = "<li><a href='" . str_replace("{page}", $totalpage, $tnamerule) . "'>末页</a></li>\r\n";
            $nextpage = "<a class='oran_pg_np' href='" . str_replace("{page}", $nextpagenum, $tnamerule) . "'>&nbsp;</a>";
            $endpage = "<a class='oran_pg_lp' href='" . str_replace("{page}", $totalpage, $tnamerule) . "'>&nbsp;</a>";
        } else {
//            $endpage = "<li>末页</li>\r\n";
        }
        ...
        for ($j; $j <= $total_list; $j++) {
            if ($j == $this->PageNo) {
                $listdd .= "<a class='cur' href='javascript:void(0)'>$j</a>";
...
//        if (preg_match('/info/i', $listitem)) $plist .= $maininfo;
        ...
        // 自定义分页样式
        $selfPageList = '';
        $selfPageList .= "<span class='cust_txt'>记录总数：$this->TotalResult | 页数：$totalpage</span>";
        $selfPageList .= $indexpage;
        $selfPageList .= $prepage;
        $selfPageList .= $listdd;
        $selfPageList .= $nextpage;
        $selfPageList .= $endpage;
    ...
    function GetPageListDM($list_len, $listitem = "index,end,pre,next,pageno")
    {
        ...
        $totalpage = ceil($this->TotalResult / $this->PageSize);
        if ($totalpage <= 1 && $this->TotalResult > 0) {
            return "<span class='cust_txt'>记录总数：$this->TotalResult | 页数：$totalpage</span>";
...
//            $indexpage = "<li><a href='" . $purl . "PageNo=1'>首页</a></li>\r\n";
            $prepage = "<a class='oran_pg_pp' href='" . $purl . "PageNo=$prepagenum'>&nbsp;</a>";
            $indexpage = "<a class='oran_pg_fp' href='" . $purl . "PageNo=1'>&nbsp;</a>";
        } else {
//            $indexpage = "<li><a>首页</a></li>\r\n";
//            $indexpage = "<a class='oran_pg_fp' href=javascript:void(0)'>&nbsp;</a>";
        }

        if ($this->PageNo != $totalpage && $totalpage > 1) {
//            $nextpage .= "<li><a href='" . $purl . "PageNo=$nextpagenum'>下一页</a></li>\r\n";
//            $endpage = "<li><a href='" . $purl . "PageNo=$totalpage'>末页</a></li>\r\n";
            $nextpage = "<a class='oran_pg_np' href='" . $purl . "PageNo=$nextpagenum'>&nbsp;</a>";
            $endpage = "<a class='oran_pg_lp' href='" . $purl . "PageNo=$totalpage'>&nbsp;</a>";
        } else {
//            $endpage = "<li><a>末页</a></li>\r\n";
//            $endpage = "<a class='oran_pg_lp' href=javascript:void(0)'>&nbsp;</a>";
        }
...
//        $slefageList .= "<a class=\"oran_pg_fp\" href=\"http://www.dnee.com.cn/zxzx-1.html\">&nbsp;</a>"; //首页
//        $slefPageList .= "<a class=\"oran_pg_pp\" href=\"http://www.dnee.com.cn/zxzx-2.html\">&nbsp;</a>"; // 上一页
//        $slefPageList .= "<a href=\"javascript:void(0)\" class=\"cur\">1</a>";
//        $slefPageList .= "<a href=\"http://www.dnee.com.cn/zxzx-2.html\">2</a>";
//        $slefPageList .= "<a href=\"http://www.dnee.com.cn/zxzx-3.html\">3</a>";
//        $slefPageList .= "<a class=\"oran_pg_np\" href=\"http://www.dnee.com.cn/zxzx-2.html\">&nbsp;</a>"; // 下一页
//        $slefPageList .= "<a class=\"oran_pg_lp\" href=\"##\">&nbsp;</a>"; // 最后一页P
