...
function $confirm(b, l, o) {
  ...
  if (e.length == 0) {
    var m = "<div id='mesbook1_c'><div><img onclick='hideMsg()' id='mesbook1_cImgClose' src='"
        + SKIN_PATH
        + "images/common/ico9_close.gif' alt='关闭' class='fr p vam' /><span id='mesbook1_cTitle'></span></div><dl class='b1'><dt><img id='mesbook1_cIcon' src='"
        + SKIN_PATH
...
function $a(c, p, g, l, o, a) {
  ...
  if (f.length == 0) {
    var n = "<div id='mesbook1'><div><img style='float:right' onclick='hideMsg()' id='mesbook1ImgClose' src='"
        ...
        + SKIN_PATH
        + "images/message_ico_03.gif' alt='' title='' /></dt><dd class='l_25' id='mesbook1Msg'></dd><dd class='b' style='visibility:hidden' id='mesbook1AutoClose'>此窗口<span id='mesbook1Delay' style='margin:0 5px;'></span>秒钟后自动关闭。</dd><dd id='mesbook1Btns'><input type='button' class='b15' value='关 闭' /></dd></dl></div>";
...
function showProc(c, a) {
  ...
  if (a) {
    ...
    $("<img src='" + SKIN_PATH
        + "images/common/processing.gif' id='imgProc' alt='正在处理' />").insertAfter(
        c)
  } else {
    $(c).show();
    b.remove()
...
function SetHome(c, d) {
  try {
    ...
    if (window.netscape) {
      ...
      var a = Components.classes["@mozilla.org/preferences-service;1"].getService(
...
function showBgProc(a, d) {
  ...
  if (c.length == 0) {
    $(document.body).append("<div id='" + b + "'><p><img src='" + SKIN_PATH
        + "images/common/processing_2.gif' id='imgProc' alt='" + d
...
function copyUrl(c) {
  ...
  if (b.length == 0) {
    var d = "<div id='div_nsw_copy_url'><h1><a href='javascript:void(0)' onclick=\"$(this).parent().parent().fadeOut(80);hideFullBg('div_nsw_copy_url_bg')\"><img src='"
        + SKIN_PATH
        + "images/common/ico9_close.gif' /></a>拷贝链接地址</h1><div class='cont'><div>拷贝本URL从您的博客或者网站链接到本"
...
function ShowHelp(b) {
  ...
  if (a.length == 0) {
    var c = "<div id='div_nsw_show_help'><h1><a href='javascript:void(0)' onclick=\"$(this).parent().parent().fadeOut(80);hideFullBg('div_nsw_show_help_bg')\"><img src='"
        + SKIN_PATH
        + "images/common/ico9_close.gif' /></a>帮助说明</h1><div class='cont'><textarea>"
        + b
        + "</textarea></div></div>";
    $(document.body).append(c)
  }
...
function submitOrder(a) {
  ...
  $.post("diy.php?action=post&diyid=1", {
    txtcontact: d,
    txtcompname: j,
    txttel: k,
    txtmobile: h,
